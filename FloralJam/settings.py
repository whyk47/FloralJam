"""
Django settings for FloralJam project.
...
SECRET_KEY = 'django-insecure-9px4bnc!v5!*zq348bg43lg$lgm^k47ui7xy$@6ns7ge#p*%uw'
...
WSGI_APPLICATION = 'FloralJam.wsgi.application'
